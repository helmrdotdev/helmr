...
VALUES ('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_region_id'), 'console-demo', 'Console Demo', true)
ON CONFLICT (id) DO UPDATE
...
VALUES
    ('00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000301', current_setting('helmr.seed_region_id'), 'production', 'Production', '#315FCE', true),
    ('00000000-0000-0000-0000-000000000402', '00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000301', current_setting('helmr.seed_region_id'), 'staging', 'Staging', '#F59E0B', false)
ON CONFLICT (id) DO UPDATE
   SET default_region_id = EXCLUDED.default_region_id,
       slug = EXCLUDED.slug,
       name = EXCLUDED.name,
...
INSERT INTO deployments (
    id, org_id, cell_id, project_id, environment_id, worker_group_id, version, content_hash,
...
INSERT INTO tasks (id, org_id, cell_id, project_id, environment_id, task_id, metadata)
VALUES
    ('00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', 'code-review', '{"title":"Review branch"}'),
    ('00000000-0000-0000-0000-000000000802', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', 'approval-message', '{"title":"Collect approval"}'),
    ('00000000-0000-0000-0000-000000000803', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', 'failure-boundary', '{"title":"Failure example"}'),
    ('00000000-0000-0000-0000-000000000804', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', 'release-summary', '{"title":"Release summary"}')
...
INSERT INTO workspaces (id, org_id, cell_id, project_id, environment_id, deployment_sandbox_id, sandbox_id, sandbox_fingerprint, external_id, metadata, tags)
VALUES
    ('00000000-0000-0000-0000-000000000901', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000701', 'node-22', 'sha256:dev-sandbox-contract', 'dev/code-review', '{"purpose":"active review"}', ARRAY['demo']),
    ('00000000-0000-0000-0000-000000000902', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000701', 'node-22', 'sha256:dev-sandbox-contract', 'dev/approval', '{"purpose":"waiting approval"}', ARRAY['demo']),
    ('00000000-0000-0000-0000-000000000903', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000701', 'node-22', 'sha256:dev-sandbox-contract', 'dev/failure', '{"purpose":"failed run"}', ARRAY['demo']),
...
INSERT INTO workspace_versions (id, org_id, cell_id, project_id, environment_id, workspace_id, kind, state, artifact_id, artifact_encoding, artifact_entry_count, content_digest, size_bytes, message, promoted_at, created_by_subject_type, created_by_subject_id)
VALUES
    ('00000000-0000-0000-0000-000000000911', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000901', 'system', 'ready', '00000000-0000-0000-0000-000000000505', 'tar', 8, 'sha256:dev-workspace-version', 1024, 'Initial dev workspace', now() - interval '3 hours', 'system', 'dev-seed'),
...
INSERT INTO sessions (
    id, org_id, cell_id, project_id, environment_id, task_id, initial_deployment_id,
...
INSERT INTO runs (
    id, org_id, cell_id, project_id, environment_id, deployment_id, deployment_task_id,
...
INSERT INTO session_runs (id, org_id, cell_id, project_id, environment_id, session_id, run_id, deployment_id, turn_index, reason, ended_at)
VALUES
    ...
    ('00000000-0000-0000-0000-000000001302', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000001002', '00000000-0000-0000-0000-000000001102', '00000000-0000-0000-0000-000000000601', 0, 'initial', NULL),
    ('00000000-0000-0000-0000-000000001303', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000001003', '00000000-0000-0000-0000-000000001103', '00000000-0000-0000-0000-000000000601', 0, 'initial', now() - interval '21 minutes'),
    ('00000000-0000-0000-0000-000000001304', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000001004', '00000000-0000-0000-0000-000000001104', '00000000-0000-0000-0000-000000000601', 0, 'initial', now() - interval '12 minutes')
ON CONFLICT (id) DO UPDATE
   SET cell_id = EXCLUDED.cell_id,
       reason = EXCLUDED.reason,
       ended_at = EXCLUDED.ended_at;

INSERT INTO task_schedules (id, org_id, cell_id, project_id, schedule_type, task_id, dedup_key, user_dedup_key, external_id, cron, timezone, active)
VALUES ('00000000-0000-0000-0000-000000001401', '00000000-0000-0000-0000-000000000201', current_setting('helmr.seed_cell_id'), '00000000-0000-0000-0000-000000000301', 'imperative', 'release-summary', 'dev-release-summary', 'dev-release-summary', 'dev/release-summary', '*/15 * * * *', 'UTC', true)
ON CONFLICT (id) DO UPDATE
   SET cell_id = EXCLUDED.cell_id,
       task_id = EXCLUDED.task_id,
       cron = EXCLUDED.cron,
