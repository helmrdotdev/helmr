...
func CapturePacked(c *Codec, data, packs *Store, base Locator, changes map[uint64][]byte, limit int, internal bool) (Locator, error) {
...
func NewPacked(c *Codec, packs *Store, capacity int64, fanout, limit int) (Locator, error) {
