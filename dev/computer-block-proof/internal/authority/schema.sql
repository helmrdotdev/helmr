...
CREATE TABLE computer_objects (
  environment_id text NOT NULL, digest text NOT NULL,
  ...
  rank integer NOT NULL CHECK (rank >= 0), key_version integer NOT NULL,
...
CREATE TABLE computer_object_edges (
  environment_id text NOT NULL, parent_digest text NOT NULL, child_digest text NOT NULL,
  ...
  FOREIGN KEY (environment_id,parent_digest,parent_rank)
    REFERENCES computer_objects(environment_id,digest,rank) ON DELETE CASCADE,
  FOREIGN KEY (environment_id,child_digest,child_rank,required)
...
CREATE TABLE computer_versions (
  ...
  parent_id text, PRIMARY KEY (environment_id,id),
  FOREIGN KEY (environment_id,parent_id) REFERENCES computer_versions(environment_id,id)
);
CREATE TABLE computer_version_roots (
  environment_id text NOT NULL, version_id text NOT NULL, digest text NOT NULL,
  page_offset bigint NOT NULL CHECK (page_offset >= 0), capacity bigint NOT NULL CHECK (capacity > 0),
  required boolean GENERATED ALWAYS AS (true) STORED,
  PRIMARY KEY (environment_id,version_id),
  FOREIGN KEY (environment_id,version_id) REFERENCES computer_versions(environment_id,id),
  FOREIGN KEY (environment_id,digest,required) REFERENCES computer_objects(environment_id,digest,certified)
);
CREATE TABLE computers (
  environment_id text NOT NULL REFERENCES environments(id), id text NOT NULL,
  epoch bigint NOT NULL, head_id text,
  PRIMARY KEY (environment_id,id),
  FOREIGN KEY (environment_id,head_id) REFERENCES computer_version_roots(environment_id,version_id)
);
CREATE TABLE checkpoints (
  ...
  FOREIGN KEY (environment_id,version_id) REFERENCES computer_version_roots(environment_id,version_id)
);
CREATE TABLE computer_publications (
  ...
  FOREIGN KEY (environment_id,computer_id) REFERENCES computers(environment_id,id),
  FOREIGN KEY (environment_id,predecessor_id) REFERENCES computer_versions(environment_id,id),
  FOREIGN KEY (environment_id,source_pin) REFERENCES computer_version_roots(environment_id,version_id),
  FOREIGN KEY (environment_id,checkpoint_id) REFERENCES checkpoints(environment_id,id),
  FOREIGN KEY (environment_id,result_id) REFERENCES computer_versions(environment_id,id)
);
CREATE TABLE computer_publication_objects (
  environment_id text NOT NULL, publication_id text NOT NULL, digest text NOT NULL,
  PRIMARY KEY (environment_id,publication_id,digest),
  FOREIGN KEY (environment_id,publication_id) REFERENCES computer_publications(environment_id,id),
...
CREATE TABLE attempts (
  environment_id text NOT NULL, id text NOT NULL, base_version text NOT NULL,
  ...
  PRIMARY KEY (environment_id,id),
  FOREIGN KEY (environment_id,base_version) REFERENCES computer_versions(environment_id,id),
  FOREIGN KEY (environment_id,retained_version) REFERENCES computer_version_roots(environment_id,version_id)
);
CREATE TABLE waits (
  environment_id text NOT NULL, id text NOT NULL, base_version text NOT NULL,
  ...
  PRIMARY KEY (environment_id,id),
  FOREIGN KEY (environment_id,base_version) REFERENCES computer_versions(environment_id,id),
  FOREIGN KEY (environment_id,resume_version) REFERENCES computer_versions(environment_id,id),
  FOREIGN KEY (environment_id,retained_base) REFERENCES computer_version_roots(environment_id,version_id),
  FOREIGN KEY (environment_id,retained_resume) REFERENCES computer_version_roots(environment_id,version_id)
);
