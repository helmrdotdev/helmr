...
SELECT 'current_deployment' AS section,
       ...
       encode(deployments.build_runtime_digest, 'hex') AS build_runtime_digest,
       encode(deployments.build_manager_digest, 'hex') AS build_manager_digest,
       encode(deployments.build_toolchain_digest, 'hex') AS build_toolchain_digest,
       encode(deployments.program_index_digest, 'hex') AS program_index_digest,
...
SELECT 'worker_runtime_identity' AS section,
       ...
       runtime_identities.network_abi,
