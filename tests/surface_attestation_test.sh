...
assert_contains "$sql_file" "deployment_definition" "declaration SQL section"
assert_contains "$sql_file" "deployment_definitions.kind" "typed declaration SQL"
assert_not_contains "$sql_file" "deployment_sandbox" "removed Sandbox SQL section"
assert_not_contains "$sql_file" "deployment_task" "removed Task projection SQL section"
