...
> Build your own coding agent runtime. Helmr runs TypeScript tasks against GitHub checkouts inside isolated Firecracker-backed Linux guests, with declared secrets, logs, run history, and approval waitpoints before side effects.
