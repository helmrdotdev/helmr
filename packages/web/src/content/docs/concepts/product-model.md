...
| Environment | A project scope such as production, staging, or preview. Runs, secrets, and deployments are environment-scoped. Worker pools are organization capacity shared across environments. |
