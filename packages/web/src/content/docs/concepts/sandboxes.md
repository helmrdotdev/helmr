...
Helmr manages the runtime substrate around the image, including `/proc`,
`/dev`, `/dev/shm`, DNS resolver files, hostname setup, logs, Actor channels,
waits, and Secret injection. See
[Runtime environment](/docs/concepts/runtime-environment/) for the runtime
contract.
