...
Self-hosted Helmr runs in your AWS account with your own database, object storage, secrets, GitHub App, control plane, and workers.
...
- ECS Fargate runs the control and migration tasks.
