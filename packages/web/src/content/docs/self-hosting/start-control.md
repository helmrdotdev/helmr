...
Keep at least one dispatcher task running when schedules are used. The dispatcher reconciles schedule definitions from the database into Redis/Valkey, leases due slots, and creates scheduled runs.
