---
title: Operate Helmr
description: Day-two operations for the Control Plane, Workers, secrets, checkpoints, and upgrades.
...
| Area | Practice |
| --- | --- |
| Control Plane rollout | Run migrations before starting a new Control Plane image. Use `/readyz` as the readiness probe. |
...
| Networking | Private workers need outbound access to GitHub, S3, ECR, AWS APIs, and the Control Plane URL. |
