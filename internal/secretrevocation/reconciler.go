...
type workspaceExecRecoverer interface {
...
func NewReconciler(
	...
	return &Reconciler{db: database, execRecoverer: execRecoverer}, nil
}
...
func (r *Reconciler) ReconcileBatch(
	ctx context.Context,
	environmentID uuid.UUID,
	secretID uuid.UUID,
...
func (r *Reconciler) listRunCandidates(
	ctx context.Context,
	environmentID uuid.UUID,
	secretID uuid.UUID,
	revocationGeneration int64,
...
func (r *Reconciler) listProcessCandidates(
	ctx context.Context,
	environmentID uuid.UUID,
	secretID uuid.UUID,
	revocationGeneration int64,
...
func (r *Reconciler) fenceProcess(
	ctx context.Context,
...
func (r *Reconciler) recoverProcess(
	ctx context.Context,
	candidate processCandidate,
) error {
