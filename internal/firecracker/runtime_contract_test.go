...
func TestVMRuntimeDescriptorGoldenJSONAndDigest(t *testing.T) {
	const goldenJSON = `{"boot":{"dynamic_flags":["helmr.substrate=1","helmr.program=1","helmr.ip=<static_ipv4_config>"],"profiles":[{"kernel_args":"console=ttyS0 reboot=k panic=1 root=/dev/vda rootfstype=squashfs ro init=/init","name":"default"}]},"contract":"helmr.vm-runtime-descriptor.v0","devices":{"absent":["balloon","entropy","mmds"],"block_io_engine":"Sync","drives":[{"id":"rootfs","path_convention":"config.rootfs_path","read_only":true,"required":true,"root":true},{"id":"scratch","path_convention":"scratch.ext4","read_only":false,"required":true,"root":false},{"id":"substrate","path_convention":"basename(config.substrate_path)","read_only":true,"required":false,"root":false},{"id":"program_runtime","path_convention":"program_runtime.squashfs","read_only":true,"required":false,"root":false},{"id":"program","path_convention":"program.squashfs","read_only":true,"required":false,"root":false}],"network_id":"1","network_id_rule":"one_based_sdk_slice_order","vsock":{"guest_cid_allocation":"process_monotonic_uint32","guest_cid_start":3,"guest_port_protocol":"config.guest_port;checkpoint_manifest_fenced","health_port_protocol":"config.health_port;checkpoint_manifest_fenced","host_path":"<jail_root>/vsock.sock","id":"guest-vsock","snapshot_load_binding":"snapshot_state;skip_add_vsock_api"},"writable_block_cache":"Writeback"},"machine":{"huge_pages":"None","max_vcpu_count":32,"pci_enabled":false,"smt":false,"track_dirty_pages":false,"vcpu_derivation":"ceil(positive_millicpu/1000)"},"network":{"gateway_ipv4":"192.168.127.1","gateway_mac":"02:fc:00:00:00:01","guest_interface_name":"eth0","guest_ipv4_cidr":"192.168.127.2/30","guest_mac":"02:fc:00:00:00:02","mtu":1500,"netns_path":"/var/run/netns/<vm_id>","resolver_source":"worker_config","tap_name":"tap0"},"paths":{"api_socket":"api.sock","jail_root":"<jailer_chroot_base>/<firecracker_basename>/<vm_id>/root","read_only_drive_suffix":".squashfs","restore_memory":"memory.mem","scratch_disk":"scratch.ext4","snapshot_memory_pack_suffix":".memory.filepack","snapshot_memory_suffix":".mem","snapshot_scratch_pack_suffix":".scratch.filepack","snapshot_state_suffix":".vmstate","vsock_socket":"vsock.sock"},"snapshot":{"backend":"firecracker","create_type":"Full","load_enable_diff_snapshots":false,"load_memory_backend":"File","load_resume_vm":false,"pause_before_create":true,"protocol":"memory+vmstate+scratch-filepack+manifest.v0","restore_order":["recreate_network","load_paused","validate_network","resume_vm","wait_guest_health"]}}`
	const goldenDigest = "sha256:737d4f1e7d6e0ae2d27ccac5938a5c075c9b4de8df7738f6691aaa57a41e7863"
