...
var ActorTurnCommitRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 31);
var ActorTurnCommitPauseRequestSchema = /* @__PURE__ */ messageDesc(file_program, 32);
var ActorTurnCommitPauseReadySchema = /* @__PURE__ */ messageDesc(file_program, 33);
var ActorTurnCommitAppliedSchema = /* @__PURE__ */ messageDesc(file_program, 34);
var ActorOutputAppendRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 35);
var SessionInputSendRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 36);
var ActorStartRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 37);
var SessionStatusRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 38);
var SessionCloseRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 39);
var SessionOutputPageRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 40);
var WorkspaceAddressSchema = /* @__PURE__ */ messageDesc(file_program, 41);
var WorkspaceSecretPlacementSchema = /* @__PURE__ */ messageDesc(file_program, 42);
var WorkspaceCreateRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 43);
var WorkspaceRetrieveRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 44);
var WorkspaceFileReadRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 45);
var WorkspaceFileStatRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 46);
var WorkspaceFileListRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 47);
var WorkspaceExecRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 48);
var WorkspaceDeleteRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 49);
var ProgramQuiescedSchema = /* @__PURE__ */ messageDesc(file_program, 50);
var RunWaitRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 51);
var TokenCreateRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 52);
var TaskChildInvokeRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 53);
var CheckpointPauseRequestSchema = /* @__PURE__ */ messageDesc(file_program, 54);
var ResumeAttachSchema = /* @__PURE__ */ messageDesc(file_program, 55);
var ResumeDecisionSchema = /* @__PURE__ */ messageDesc(file_program, 56);
var ResumeAckSchema = /* @__PURE__ */ messageDesc(file_program, 57);
var ResumeConsumedSchema = /* @__PURE__ */ messageDesc(file_program, 58);
var MetadataUpdatedSchema = /* @__PURE__ */ messageDesc(file_program, 59);
var StructuredLogRequestedSchema = /* @__PURE__ */ messageDesc(file_program, 60);
  ...
  const performWorkspaceFileRead = async (workspaceId, filePath, signal) => {
    ...
    const operation = runOperations.trackDrainable(async () => {
      const decision = await requestRuntimeDecision(io, decisions, correlationId, {
        ...
        value: create(exports_program_pb.WorkspaceFileReadRequestedSchema, {
          correlationId,
          workspace: workspaceAddress(workspaceId),
          path: filePath
        })
  ...
  const performWorkspaceFileStat = async (workspaceId, filePath, signal) => {
    ...
    const operation = runOperations.trackDrainable(async () => {
      const decision = await requestRuntimeDecision(io, decisions, correlationId, {
        ...
        value: create(exports_program_pb.WorkspaceFileStatRequestedSchema, {
          correlationId,
          workspace: workspaceAddress(workspaceId),
          path: filePath
        })
  ...
  const performWorkspaceFileList = async (workspaceId, filePath, query = {}, signal) => {
    ...
    const operation = runOperations.trackDrainable(async () => {
      const decision = await requestRuntimeDecision(io, decisions, correlationId, {
        ...
        value: create(exports_program_pb.WorkspaceFileListRequestedSchema, {
          correlationId,
          workspace: workspaceAddress(workspaceId),
          path: filePath,
