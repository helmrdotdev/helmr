...
func (x *MaterializeWorkspaceRequest) GetTarget() *ComputerMountTarget {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *MaterializeWorkspaceResponse) GetTarget() *ComputerMountTarget {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *ComputerMountTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ComputerMountTarget) GetBaseWorkspaceVersionId() string {
	if x != nil {
		return x.BaseWorkspaceVersionId
	}
	return ""
...
const file_workspace_proto_rawDesc = "" +
	...
	"\x05fence\x18\x03 \x01(\v2+.helmr.workspace.v0.WorkspaceAuthorityFenceR\x05fence\"\xec\x03\n" +
	...
	"\x06target\x18\x03 \x01(\v2'.helmr.workspace.v0.ComputerMountTargetR\x06target\x12N\n" +
	...
	"entryCount\x12\x14\n" +
	"\x05error\x18\x05 \x01(\tR\x05error\"\xf3\x01\n" +
	...
	"\x06target\x18\x04 \x01(\v2'.helmr.workspace.v0.ComputerMountTargetR\x06target\"\x8d\x01\n" +
	...
	"\x13ComputerMountTarget\x129\n" +
	"\x19base_workspace_version_id\x18\x01 \x01(\tR\x16baseWorkspaceVersionId\"b\n" +
	"\x14StopWorkspaceRequest\x12J\n" +
	"\benvelope\x18\x01 \x01(\v2..helmr.workspace.v0.WorkspaceOperationEnvelopeR\benvelope\"N\n" +
	"\x15StopWorkspaceResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x1d\n" +
	"\n" +
	"error_json\x18\x02 \x01(\tR\terrorJson\"\xc4\x04\n" +
...
var file_workspace_proto_goTypes = []any{
	...
	(*ComputerMountTarget)(nil),                // 25: helmr.workspace.v0.ComputerMountTarget
	(*StopWorkspaceRequest)(nil),               // 26: helmr.workspace.v0.StopWorkspaceRequest
	(*StopWorkspaceResponse)(nil),              // 27: helmr.workspace.v0.StopWorkspaceResponse
	(*WorkspaceBasicExecRequest)(nil),          // 28: helmr.workspace.v0.WorkspaceBasicExecRequest
	(*WorkspaceBasicExecResult)(nil),           // 29: helmr.workspace.v0.WorkspaceBasicExecResult
	(*WorkspaceSecretDelivery)(nil),            // 30: helmr.workspace.v0.WorkspaceSecretDelivery
	nil,                                        // 31: helmr.workspace.v0.WorkspaceBasicExecRequest.ProtectedEnvEntry
}
var file_workspace_proto_depIdxs = []int32{
	...
	25, // 10: helmr.workspace.v0.MaterializeWorkspaceRequest.target:type_name -> helmr.workspace.v0.ComputerMountTarget
	...
	25, // 13: helmr.workspace.v0.MaterializeWorkspaceResponse.target:type_name -> helmr.workspace.v0.ComputerMountTarget
	...
	0,  // 22: helmr.workspace.v0.StopWorkspaceRequest.envelope:type_name -> helmr.workspace.v0.WorkspaceOperationEnvelope
	0,  // 23: helmr.workspace.v0.WorkspaceBasicExecRequest.envelope:type_name -> helmr.workspace.v0.WorkspaceOperationEnvelope
	30, // 24: helmr.workspace.v0.WorkspaceBasicExecRequest.secrets:type_name -> helmr.workspace.v0.WorkspaceSecretDelivery
	31, // 25: helmr.workspace.v0.WorkspaceBasicExecRequest.protected_env:type_name -> helmr.workspace.v0.WorkspaceBasicExecRequest.ProtectedEnvEntry
