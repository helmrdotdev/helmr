...
func (x *WorkspaceBasicExecRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkspaceBasicExecRequest) GetRequestJson() string {
	if x != nil {
...
func (x *WorkspaceBasicExecRequest) GetSecrets() []*WorkspaceSecretDelivery {
	if x != nil {
		return x.Secrets
	}
	return nil
...
func (x *WorkspaceBasicExecRequest) GetStdin() []byte {
	if x != nil {
		return x.Stdin
	}
	return nil
...
func (x *WorkspaceBasicExecResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkspaceBasicExecResult) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *WorkspaceBasicExecResult) GetStdout() []byte {
	if x != nil {
		return x.Stdout
	}
	return nil
...
func (x *WorkspaceBasicExecResult) GetStderr() []byte {
	if x != nil {
		return x.Stderr
	}
	return nil
...
func (x *WorkspaceBasicExecResult) GetOutcome() string {
	if x != nil {
		return x.Outcome
	}
	return ""
...
func (x *WorkspaceBasicExecResult) GetRequestFingerprint() string {
	if x != nil {
		return x.RequestFingerprint
	}
	return ""
...
const file_workspace_proto_rawDesc = "" +
	...
	"\x06stderr\x18\x04 \x01(\fR\x06stderr\x12\x18\n" +
	"\aoutcome\x18\x05 \x01(\tR\aoutcome\x12/\n" +
	"\x13request_fingerprint\x18\x06 \x01(\tR\x12requestFingerprint\"\x81\x01\n" +
	...
	"\x05value\x18\x03 \x01(\fR\x05valueBFZDgithub.com/helmrdotdev/helmr/internal/proto/workspace/v0;workspacev0b\x06proto3"
...
var file_workspace_proto_goTypes = []any{
	...
	(*StopWorkspaceRequest)(nil),               // 27: helmr.workspace.v0.StopWorkspaceRequest
	(*StopWorkspaceResponse)(nil),              // 28: helmr.workspace.v0.StopWorkspaceResponse
	(*WorkspaceBasicExecRequest)(nil),          // 29: helmr.workspace.v0.WorkspaceBasicExecRequest
	(*WorkspaceBasicExecResult)(nil),           // 30: helmr.workspace.v0.WorkspaceBasicExecResult
	(*WorkspaceSecretDelivery)(nil),            // 31: helmr.workspace.v0.WorkspaceSecretDelivery
	nil,                                        // 32: helmr.workspace.v0.WorkspaceBasicExecRequest.ProtectedEnvEntry
}
var file_workspace_proto_depIdxs = []int32{
	...
	12, // 27: helmr.workspace.v0.StopWorkspaceResponse.captured_tree:type_name -> helmr.workspace.v0.WorkspaceTreeIdentity
	0,  // 28: helmr.workspace.v0.WorkspaceBasicExecRequest.envelope:type_name -> helmr.workspace.v0.WorkspaceOperationEnvelope
	31, // 29: helmr.workspace.v0.WorkspaceBasicExecRequest.secrets:type_name -> helmr.workspace.v0.WorkspaceSecretDelivery
	32, // 30: helmr.workspace.v0.WorkspaceBasicExecRequest.protected_env:type_name -> helmr.workspace.v0.WorkspaceBasicExecRequest.ProtectedEnvEntry
