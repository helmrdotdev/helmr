...
GET /api/workspaces/{workspaceID}/files/stat
...
POST /api/worker/runtime-instances/prepared-runtime
...
POST /api/worker/workspaces/mounts/operations/claim
POST /api/worker/workspaces/mounts/operations/complete
POST /api/worker/workspaces/mounts/operations/start
