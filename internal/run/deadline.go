...
const (
	deadlinePollInterval = 250 * time.Millisecond
	deadlineBatchLimit   = int32(100)
)
...
func (w *DeadlineWorker) Run(ctx context.Context) error {
...
func (w *DeadlineWorker) tick(ctx context.Context) error {
