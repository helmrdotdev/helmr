...
type Querier interface {
	...
	ArchiveProjectWithEnvironments(ctx context.Context, arg ArchiveProjectWithEnvironmentsParams) (Project, error)
	...
	ConnectProjectGitHubRepository(ctx context.Context, arg ConnectProjectGitHubRepositoryParams) (ProjectGithubRepository, error)
	...
	CreateProjectWithDefaultEnvironment(ctx context.Context, arg CreateProjectWithDefaultEnvironmentParams) (Project, error)
	CreateQueuedWaitpointEmailDelivery(ctx context.Context, arg CreateQueuedWaitpointEmailDeliveryParams) (WaitpointDelivery, error)
	...
	GetActiveProjectGitHubRepository(ctx context.Context, arg GetActiveProjectGitHubRepositoryParams) (GetActiveProjectGitHubRepositoryRow, error)
	GetActiveProjectGitHubRepositoryByFullName(ctx context.Context, arg GetActiveProjectGitHubRepositoryByFullNameParams) (GetActiveProjectGitHubRepositoryByFullNameRow, error)
	...
	GetWaitpointForDelivery(ctx context.Context, arg GetWaitpointForDeliveryParams) (Waitpoint, error)
	...
	RecordWaitpointResponse(ctx context.Context, arg RecordWaitpointResponseParams) (WaitpointResponse, error)
