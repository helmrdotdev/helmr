...
type Querier interface {
	...
	GetRunLeaseRenewalLocators(ctx context.Context, arg GetRunLeaseRenewalLocatorsParams) (GetRunLeaseRenewalLocatorsRow, error)
	...
	LockRunLeaseRenewalLease(ctx context.Context, arg LockRunLeaseRenewalLeaseParams) (RunLease, error)
	...
	TaskCompletionScopeIsClear(ctx context.Context, arg TaskCompletionScopeIsClearParams) (pgtype.Bool, error)
