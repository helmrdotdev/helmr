...
type Querier interface {
	...
	CreateTaskSessionWorkspace(ctx context.Context, arg CreateTaskSessionWorkspaceParams) (CreateTaskSessionWorkspaceRow, error)
	...
	GetTaskSessionWorkspace(ctx context.Context, arg GetTaskSessionWorkspaceParams) (Workspace, error)
