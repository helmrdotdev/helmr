...
type Querier interface {
	...
	ArchiveWorkerPoolForOrg(ctx context.Context, arg ArchiveWorkerPoolForOrgParams) (WorkerPool, error)
	...
	EnsureDefaultWorkerPool(ctx context.Context, id pgtype.UUID) (EnsureDefaultWorkerPoolRow, error)
	...
	GetWorkerPool(ctx context.Context, arg GetWorkerPoolParams) (WorkerPool, error)
	GetWorkerPoolByID(ctx context.Context, id pgtype.UUID) (WorkerPool, error)
	...
	ListWorkerHostsByWorkerPool(ctx context.Context, arg ListWorkerHostsByWorkerPoolParams) ([]WorkerHost, error)
	ListWorkerPoolQueueScopes(ctx context.Context, arg ListWorkerPoolQueueScopesParams) ([]ListWorkerPoolQueueScopesRow, error)
	...
	SetDefaultOrgWorkerPool(ctx context.Context, arg SetDefaultOrgWorkerPoolParams) (SetDefaultOrgWorkerPoolRow, error)
	...
	UpsertOrgWorkerPool(ctx context.Context, arg UpsertOrgWorkerPoolParams) (OrgWorkerPool, error)
	...
	UpsertWorkerRegistrationToken(ctx context.Context, arg UpsertWorkerRegistrationTokenParams) (WorkerRegistrationToken, error)
}
