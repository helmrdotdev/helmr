...
type Querier interface {
	...
	ActivateWorkerInstance(ctx context.Context, arg ActivateWorkerInstanceParams) (ActivateWorkerInstanceRow, error)
	...
	CommitActorInputCursor(ctx context.Context, arg CommitActorInputCursorParams) (Session, error)
	...
	DrainAbsentWorkerGroups(ctx context.Context, arg DrainAbsentWorkerGroupsParams) ([]DrainAbsentWorkerGroupsRow, error)
	...
	FailDeploymentPlatformAcquisition(ctx context.Context, arg FailDeploymentPlatformAcquisitionParams) (Deployment, error)
	...
	GetActorByAddressID(ctx context.Context, arg GetActorByAddressIDParams) (Session, error)
	...
	GetActorWakeupRecord(ctx context.Context, arg GetActorWakeupRecordParams) (SessionRecord, error)
	...
	GetDeploymentPlatformAcquisition(ctx context.Context, arg GetDeploymentPlatformAcquisitionParams) (GetDeploymentPlatformAcquisitionRow, error)
	...
	GetNextDeploymentPlatformAcquisition(ctx context.Context, arg GetNextDeploymentPlatformAcquisitionParams) (GetNextDeploymentPlatformAcquisitionRow, error)
	...
	GetSessionRead(ctx context.Context, arg GetSessionReadParams) (Session, error)
	...
	GetWorkspaceByKey(ctx context.Context, arg GetWorkspaceByKeyParams) (Workspace, error)
	...
	ListActorInputRecords(ctx context.Context, arg ListActorInputRecordsParams) ([]SessionRecord, error)
	ListActorOutputRecords(ctx context.Context, arg ListActorOutputRecordsParams) ([]SessionRecord, error)
	...
	ListRegistryCredentialResolutions(ctx context.Context, arg ListRegistryCredentialResolutionsParams) ([]RegistryCredentialResolution, error)
	ListRevokedImageOperationIDsForBuildLease(ctx context.Context, buildLeaseID pgtype.UUID) ([]pgtype.UUID, error)
	...
	ListWorkspaceSnapshots(ctx context.Context, arg ListWorkspaceSnapshotsParams) ([]Workspace, error)
	...
	LockCompletedWorkspaceImageOperation(ctx context.Context, arg LockCompletedWorkspaceImageOperationParams) (IdempotencyClaim, error)
	...
	LockDeploymentBuildWorkerAuthority(ctx context.Context, arg LockDeploymentBuildWorkerAuthorityParams) (LockDeploymentBuildWorkerAuthorityRow, error)
	...
	LockRegistryCredentialBuildLease(ctx context.Context, arg LockRegistryCredentialBuildLeaseParams) (LockRegistryCredentialBuildLeaseRow, error)
	LockRegistryCredentialImageOperation(ctx context.Context, arg LockRegistryCredentialImageOperationParams) (IdempotencyClaim, error)
	LockRegistryCredentialResolutionForDelivery(ctx context.Context, arg LockRegistryCredentialResolutionForDeliveryParams) (LockRegistryCredentialResolutionForDeliveryRow, error)
	LockRegistryCredentialSecretsByName(ctx context.Context, arg LockRegistryCredentialSecretsByNameParams) ([]Secret, error)
	...
	LockWorkspaceImageOperationForResult(ctx context.Context, arg LockWorkspaceImageOperationForResultParams) (IdempotencyClaim, error)
	...
	PinDeploymentPlatformArtifacts(ctx context.Context, arg PinDeploymentPlatformArtifactsParams) (PinDeploymentPlatformArtifactsRow, error)
