...
type Querier interface {
	...
	CreateDeployment(ctx context.Context, arg CreateDeploymentParams) (CreateDeploymentRow, error)
	...
	GetCurrentDeployment(ctx context.Context, arg GetCurrentDeploymentParams) (GetCurrentDeploymentRow, error)
