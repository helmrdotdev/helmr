...
type Querier interface {
	...
	GetFreshRunLeaseLossAuthority(ctx context.Context, arg GetFreshRunLeaseLossAuthorityParams) (GetFreshRunLeaseLossAuthorityRow, error)
	...
	ListFreshRunLeaseRecoveryCandidates(ctx context.Context, limitCount int32) ([]ListFreshRunLeaseRecoveryCandidatesRow, error)
