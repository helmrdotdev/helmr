...
type Querier interface {
	...
	CreateExpiredRuntimeStopCommands(ctx context.Context, expiredBefore pgtype.Timestamptz) ([]WorkerCommand, error)
	...
	MarkExpiredRuntimeInstancesLost(ctx context.Context, expiredBefore pgtype.Timestamptz) ([]RuntimeInstance, error)
