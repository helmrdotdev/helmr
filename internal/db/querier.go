...
type Querier interface {
	...
	ListActiveAbsentWorkerGroupIDs(ctx context.Context, arg ListActiveAbsentWorkerGroupIDsParams) ([]string, error)
	...
	LoseWorkerInstanceForDrift(ctx context.Context, arg LoseWorkerInstanceForDriftParams) (LoseWorkerInstanceForDriftRow, error)
	...
	RenewWorkerCertification(ctx context.Context, arg RenewWorkerCertificationParams) (WorkerInstance, error)
