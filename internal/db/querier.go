...
type Querier interface {
	...
	AdvanceWorkspaceExecWriter(ctx context.Context, arg AdvanceWorkspaceExecWriterParams) (Workspace, error)
	...
	ExpirePendingWorkspaceExecs(ctx context.Context, arg ExpirePendingWorkspaceExecsParams) (int64, error)
	...
	FailPendingWorkspaceExec(ctx context.Context, arg FailPendingWorkspaceExecParams) (FailPendingWorkspaceExecRow, error)
	...
	ListWorkspaceExecTerminalRecords(ctx context.Context, arg ListWorkspaceExecTerminalRecordsParams) ([]WorkspaceProcessRecord, error)
