...
type Querier interface {
	...
	ListCurrentSecretKeyUsage(ctx context.Context) ([]ListCurrentSecretKeyUsageRow, error)
	ListCurrentSecretsByKeyID(ctx context.Context, arg ListCurrentSecretsByKeyIDParams) ([]ListCurrentSecretsByKeyIDRow, error)
