...
func TestOperatorWorkerListingProjectsCurrentRowPerOpaqueLocator(t *testing.T) {
	...
	rows, err := queries.ListOperatorWorkerInstances(ctx, db.ListOperatorWorkerInstancesParams{
