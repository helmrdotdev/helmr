...
inserted_wait AS (
    ...
    SELECT $7,
           ...
           $10::timestamptz,
           CASE
             WHEN $11::interval <= interval '0 seconds' THEN now()
             ELSE now() + $11::interval
           END,
           now(),
