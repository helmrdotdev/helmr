...
instance AS (
    ...
    SELECT $14,
           ...
           $16
      FROM schedule
    RETURNING id, schedule_id, org_id, project_id, environment_id, active, generation, next_scheduled_at, next_due_at, last_scheduled_at, created_at, updated_at
)
