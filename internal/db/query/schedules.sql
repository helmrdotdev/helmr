...
WITH schedule AS (
    INSERT INTO task_schedules (
        ...
        sqlc.arg(generator_type)::task_schedule_generator_type,
        sqlc.arg(generator_expression),
        sqlc.arg(generator_description),
        sqlc.arg(timezone),
...
WITH updated_schedule AS (
    UPDATE task_schedules
       SET task_id = sqlc.arg(task_id),
           ...
           generator_type = sqlc.arg(generator_type)::task_schedule_generator_type,
           generator_expression = sqlc.arg(generator_expression),
           generator_description = sqlc.arg(generator_description),
