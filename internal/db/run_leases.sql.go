...
func (q *Queries) GetRunLeaseRuntimeIdentity(ctx context.Context, arg GetRunLeaseRuntimeIdentityParams) (RuntimeIdentity, error) {
	row := q.db.QueryRow(ctx, getRunLeaseRuntimeIdentity,
		arg.OrgID,
		arg.RunID,
		arg.RunLeaseID,
		arg.WorkerInstanceID,
