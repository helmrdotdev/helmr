...
`, sourceDigest); err != nil {
	...
	if _, err := pool.Exec(ctx, `
INSERT INTO deployments (id, org_id, project_id, environment_id, source_digest, build_manifest_digest, deployment_manifest_digest, content_hash, status, building_at, indexed_at, deployed_at)
