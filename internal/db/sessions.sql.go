...
SELECT id, public_id, org_id, cell_id, project_id, environment_id, task_id, metadata, created_at, updated_at, archived_at
  FROM tasks
 WHERE org_id = $1
   AND cell_id = $2
   AND project_id = $3
