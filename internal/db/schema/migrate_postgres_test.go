...
func assertNoBusinessDatabaseLogic(
	...
	if strings.Join(generatedColumns, ",") != "cas_object_lifetimes.available:s,cas_objects.availability_required:s,computer_initializations.availability_required:s,computer_keys.available:s,computer_object_edges.certification_required:s,computer_object_keys.availability_required:s,computer_object_read_keys.availability_required:s,computer_objects.availability_required:s,computer_objects.certified:s,computer_objects.certified_org_id:s,computer_version_roots.certification_required:s,computer_version_roots.root_digest:s,computer_version_roots.root_key_id:s,computer_version_roots.root_rank:s,computer_version_roots.root_size_bytes:s,run_checkpoint_objects.availability_required:s,run_finalization_objects.availability_required:s,runtime_instances.computer_key_available:s,runtime_instances.retained_computer_source_version_id:s,runtime_instances.retained_computer_write_key_id:s,telemetry_outbox.ingest_size_bytes:s,workspaces.write_key_available:s" {
