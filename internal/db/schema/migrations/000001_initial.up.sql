...
CREATE TABLE run_events_p00 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 0);
CREATE TABLE run_events_p01 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 1);
CREATE TABLE run_events_p02 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 2);
CREATE TABLE run_events_p03 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 3);
CREATE TABLE run_events_p04 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 4);
CREATE TABLE run_events_p05 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 5);
CREATE TABLE run_events_p06 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 6);
CREATE TABLE run_events_p07 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 7);
CREATE TABLE run_events_p08 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 8);
CREATE TABLE run_events_p09 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 9);
CREATE TABLE run_events_p10 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 10);
CREATE TABLE run_events_p11 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 11);
CREATE TABLE run_events_p12 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 12);
CREATE TABLE run_events_p13 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 13);
CREATE TABLE run_events_p14 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 14);
CREATE TABLE run_events_p15 PARTITION OF run_events FOR VALUES WITH (MODULUS 16, REMAINDER 15);
...
CREATE TABLE run_log_chunks_p00 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 0);
CREATE TABLE run_log_chunks_p01 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 1);
CREATE TABLE run_log_chunks_p02 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 2);
CREATE TABLE run_log_chunks_p03 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 3);
CREATE TABLE run_log_chunks_p04 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 4);
CREATE TABLE run_log_chunks_p05 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 5);
CREATE TABLE run_log_chunks_p06 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 6);
CREATE TABLE run_log_chunks_p07 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 7);
CREATE TABLE run_log_chunks_p08 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 8);
CREATE TABLE run_log_chunks_p09 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 9);
CREATE TABLE run_log_chunks_p10 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 10);
CREATE TABLE run_log_chunks_p11 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 11);
CREATE TABLE run_log_chunks_p12 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 12);
CREATE TABLE run_log_chunks_p13 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 13);
CREATE TABLE run_log_chunks_p14 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 14);
CREATE TABLE run_log_chunks_p15 PARTITION OF run_log_chunks FOR VALUES WITH (MODULUS 16, REMAINDER 15);
