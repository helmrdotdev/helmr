...
DROP INDEX IF EXISTS checkpoint_availability_replicas_worker_state_idx;
DROP INDEX IF EXISTS checkpoint_availability_replicas_checkpoint_state_idx;
...
DROP TABLE IF EXISTS checkpoint_availability_replicas;
...
DROP TYPE IF EXISTS checkpoint_availability_state;
