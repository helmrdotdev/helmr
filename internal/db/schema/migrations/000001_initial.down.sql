...
ALTER TABLE worker_groups DROP CONSTRAINT IF EXISTS worker_groups_primary_run_pool_fkey;
ALTER TABLE worker_groups DROP CONSTRAINT IF EXISTS worker_groups_primary_build_pool_fkey;
