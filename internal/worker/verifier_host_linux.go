...
func PrepareProgramVerifierHost() error {
	return checkProgramVerifierHost("/proc/self/cgroup", "/sys/fs/cgroup", os.Getpid(), true)
}

func prepareProgramVerifierHost(procCgroup, cgroupRoot string, pid int) error {
	return checkProgramVerifierHost(procCgroup, cgroupRoot, pid, true)
}

func programVerifierHostHealthy() bool {
	return checkProgramVerifierHost("/proc/self/cgroup", "/sys/fs/cgroup", os.Getpid(), false) == nil
}

func checkProgramVerifierHost(procCgroup, cgroupRoot string, pid int, enable bool) error {
