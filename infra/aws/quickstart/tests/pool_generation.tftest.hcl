...
run "baseline_pool_generations" {
  ...
  assert {
    condition = (
      local.worker_pool_names.run == "run-f9ddccd9d32d34f1aa71bd1f493c9abe20b8793a46da95525e418c4834ace37c" &&
      local.worker_pool_names.build == "build-a638cee3cc9805f15d8a6155945d47596d807d0fea78b450fb62fe8576251e87"
    )
