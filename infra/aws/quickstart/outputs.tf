...
output "worker_iam_role_name" {
  ...
  value       = try(module.worker_group[local.worker_pool_names.run].iam_role_name, null)
}
...
output "build_worker_iam_role_name" {
  ...
  value       = try(module.worker_group[local.worker_pool_names.build].iam_role_name, null)
}
