...
variable "capacity_schedule_expression" {
  description = "EventBridge Scheduler cadence for the one-shot Managed Cloud capacity task."
  type        = string
  default     = "rate(1 minute)"
}

variable "capacity_observation_max_age" {
  description = "Maximum age of Control demand used for new Managed Cloud capacity decisions."
  type        = string
  default     = "2m"
}
