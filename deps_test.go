...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"console":             {},
		"control":             {"actorinput", "actorlifecycle", "api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "email", "frameio", "idempotency", "jsoncanon", "pgvalue", "proto/run/v0", "publicid", "region", "schedule", "secret", "sha256sum", "telemetry", "token", "tracing", "workspace"},
		"db":                  {},
		"db/dbtest":           {},
		"db/schema":           {},
