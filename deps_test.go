...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"config":             {"auth"},
		"console":            {},
		"control":            {"api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "dispatch", "email", "pgvalue", "publicid", "schedule", "secret", "sha256sum", "stablejson", "telemetry", "token", "tracing", "wire", "workspace"},
		"db":                 {},
		"db/dbtest":          {},
		"db/schema":          {},
