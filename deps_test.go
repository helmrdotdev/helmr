...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"config":              {"api", "auth", "region", "token", "workspace"},
		"console":             {},
		...
		"executor":            {"api", "capacity", "cas", "checkpoint", "client", "compute", "deployment", "frameio", "jsoncanon", "localcache", "proto/run/v0", "proto/workspace/v0", "runtime", "sha256sum", "vm", "wire", "workspace"},
		...
		"secret":              {"api", "db", "idempotency", "outbox", "pgvalue"},
		"sha256sum":           {},
