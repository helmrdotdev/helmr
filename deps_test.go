...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"config":             {"auth"},
		"console":            {},
		"control":            {"api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "dispatch", "email", "jsoncanon", "pgvalue", "publicid", "schedule", "secret", "sha256sum", "telemetry", "token", "tracing", "wire", "workspace"},
		"db":                 {},
		"db/dbtest":          {},
		"db/schema":          {},
		"deployment":         {"api", "archive", "builder", "cas", "compute", "frameio", "jsoncanon", "proto/bundle/v0", "schedule", "secret", "task", "vm", "wire"},
		...
		"worker":             {"api", "capacity", "client", "compute", "vm"},
