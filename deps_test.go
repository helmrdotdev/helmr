...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"executor":           {"api", "capacity", "cas", "checkpoint", "compute", "deployment", "frameio", "httpclient", "ids", "jsoncanon", "localcache", "proto/run/v0", "proto/workspace/v0", "runtime", "sha256sum", "vm", "wire", "workerapi", "workspace"},
