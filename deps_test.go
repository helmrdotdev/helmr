...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"email":              {},
		"executor":           {"api", "archive", "builder", "cas", "checkpoint", "compute", "localcache", "proto/bundle/v0", "proto/run/v0", "proto/workspace/v0", "runtimeprep", "sha256sum", "substrate", "task", "frameio", "vm", "wire", "workspace"},
