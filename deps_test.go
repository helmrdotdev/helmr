...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"config":          {"auth"},
		"console":         {},
		"control":         {"api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "dispatch", "email", "ids", "pgvalue", "schedule", "secret", "sha256sum", "tracing", "waitpoint"},
		"db":              {},
		"db/dbtest":       {},
		"db/schema":       {},
		...
		"email":           {},
		"executor":        {"api", "archive", "builder", "cas", "checkpoint", "compute", "proto/bundle/v0", "proto/run/v0", "sha256sum", "task", "transport", "vm", "workspace"},
		"firecracker":     {"cas", "compute", "sha256sum", "vm"},
		"guestd":          {"archive", "proto/run/v0", "safepath", "sha256sum", "transport", "workspace"},
		"ids":             {},
		"pgvalue":         {},
		"proto/bundle/v0": {},
		"proto/run/v0":    {},
		"schedule":        {"api", "db", "ids", "pgvalue"},
		"secret":          {"api", "db", "ids"},
		"sha256sum":       {},
		"safepath":        {},
		...
		"vm":              {"compute"},
		"sqs":             {},
		"waitpoint":       {"api", "auth", "db", "email", "ids", "pgvalue", "sqs"},
