...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"email":              {},
		"executor":           {"api", "archive", "builder", "cas", "checkpoint", "compute", "localcache", "proto/bundle/v0", "proto/run/v0", "proto/workspace/v0", "runtimeprep", "sha256sum", "substrate", "task", "transport", "vm", "wire", "workspace"},
		"firecracker":        {"cas", "compute", "sha256sum", "vm"},
		"guestd":             {"archive", "oci", "proto/run/v0", "proto/workspace/v0", "safepath", "sha256sum", "transport", "wire", "workspace"},
		"localcache":         {},
		"oci":                {"sha256sum"},
		"pgvalue":            {},
		"proto/bundle/v0":    {},
		...
		"version":            {},
		"vm":                 {"compute"},
		"wire":               {"proto/run/v0", "stablejson", "transport"},
		"sqs":                {},
