...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"compute":             {"sha256sum"},
		"config":              {"api", "auth", "keyedhash", "region", "workspace"},
		"console":             {},
		"control":             {"actorinput", "actorlifecycle", "api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "email", "frameio", "idempotency", "jsoncanon", "pgvalue", "proto/run/v0", "publicid", "region", "schedule", "secret", "telemetry", "token", "tracing", "workspace"},
		"db":                  {},
		"db/dbtest":           {},
		"db/schema":           {},
		"deployment":          {"api", "archive", "cas", "compute", "frameio", "imagebuild", "jsoncanon", "oci", "publicid", "region", "safepath", "schedule", "vm", "wire"},
		"dispatch":            {"compute", "db", "deployment", "jsoncanon", "pgvalue", "workspace"},
		"dispatch/redis":      {"dispatch", "pgvalue"},
		"email":               {},
		"enrollment":          {"api", "auth", "workergroup"},
		"executor":            {"api", "capacity", "cas", "checkpoint", "client", "compute", "deployment", "frameio", "jsoncanon", "localcache", "proto/run/v0", "proto/workspace/v0", "sha256sum", "substrate", "vm", "wire", "workspace"},
		...
		"idempotency":         {"db", "jsoncanon", "keyedhash", "pgvalue"},
		"imagebuild":          {},
		"jsoncanon":           {},
		"keyedhash":           {"db"},
		"localcache":          {},
		...
		"version":             {},
		"vm":                  {"compute"},
		"wire":                {"frameio", "jsoncanon", "proto/run/v0"},
		"worker":              {"api", "capacity", "client", "compute", "deployment", "vm"},
