...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"email":              {},
		"executor":           {"api", "archive", "builder", "cas", "checkpoint", "compute", "proto/bundle/v0", "proto/run/v0", "proto/workspace/v0", "runprotocol", "sha256sum", "task", "transport", "vm", "workspace"},
		"firecracker":        {"cas", "compute", "sha256sum", "vm"},
		"guestd":             {"archive", "proto/run/v0", "proto/workspace/v0", "runprotocol", "safepath", "sha256sum", "transport", "workspace", "workspace/protocol"},
		"pgvalue":            {},
		"proto/bundle/v0":    {},
		"proto/run/v0":       {},
		"proto/workspace/v0": {},
