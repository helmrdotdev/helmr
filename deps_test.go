...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"config":          {"auth"},
		"console":         {},
		"control":         {"api", "archive", "auth", "cas", "compute", "console", "db", "db/schema", "deployment", "dispatch", "email", "pgvalue", "schedule", "secret", "sha256sum", "tracing", "waitpoint"},
		"db":              {},
		"db/dbtest":       {},
		"db/schema":       {},
		...
		"vm":              {"compute"},
		"sqs":             {},
		"waitpoint":       {"api", "auth", "db", "email", "pgvalue", "sqs"},
