...
func TestInternalPackageDependencies(t *testing.T) {
	...
	expected := map[string][]string{
		"actor":               {"db", "outbox", "pgvalue", "publicid", "run", "secret", "tracing"},
		...
		"db/dbtest":           {},
		"db/schema":           {},
		"deployment":          {"api", "archive", "cas", "compute", "frameio", "imagebuild", "jsoncanon", "oci", "publicid", "region", "runtime/identity", "safepath", "schedule", "vm", "wire"},
		"dispatch":            {"compute", "db", "deployment", "jsoncanon", "pgvalue", "workspace"},
		"dispatch/redis":      {"dispatch", "pgvalue"},
		"email":               {},
		"enrollment":          {"api", "auth", "workergroup"},
		"executor":            {"api", "capacity", "cas", "checkpoint", "client", "compute", "deployment", "frameio", "jsoncanon", "localcache", "proto/run/v0", "proto/workspace/v0", "runtime/substrate", "sha256sum", "vm", "wire", "workspace"},
		"firecracker":         {"cas", "compute", "runtime/identity", "sha256sum", "vm"},
		"fleet":               {"db"},
		"frameio":             {"sha256sum"},
		...
		"safepath":            {},
		"schedule":            {"db", "pgvalue", "publicid", "run", "tracing"},
		"secret":              {"api", "db", "idempotency", "keyedhash", "outbox", "pgvalue"},
		"sha256sum":           {},
		"telemetry":           {"api", "clickhouse", "db", "pgvalue"},
		"token":               {"db", "outbox", "pgvalue"},
		"tracing":             {},
		"version":             {},
		"vm":                  {"compute"},
